...
@section('body')
    ...
    {!! Documenter::showMethod("Writecl\\Rapyd\\Demo\\DemoController", "getEmbed") !!}
    {!! Documenter::showMethod("Writecl\\Rapyd\\Demo\\DemoController", "getNudegrid") !!}
    {!! Documenter::showMethod("Writecl\\Rapyd\\Demo\\DemoController", "anyNudeedit") !!}
    {!! Documenter::showCode("writecl/rapyd/views/demo/embed.blade.php") !!}

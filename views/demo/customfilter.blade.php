...
@section('body')
    ...
    {!! Documenter::showMethod("Writecl\\Rapyd\\Demo\\DemoController", "getCustomfilter") !!}
    {!! Documenter::showMethod("Writecl\\Rapyd\\Demo\\Article", "scopeFreesearch") !!}
    {!! Documenter::showCode("writecl/rapyd/views/demo/customfilter.blade.php") !!}

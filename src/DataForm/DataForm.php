...
namespace Writecl\Rapyd\DataForm;

use Illuminate\Database\Eloquent\Model;
use Writecl\Rapyd\DataForm\Field\Auto;
use Writecl\Rapyd\DataForm\Field\Autocomplete;
use Writecl\Rapyd\DataForm\Field\Colorpicker;
use Writecl\Rapyd\DataForm\Field\Date;
use Writecl\Rapyd\DataForm\Field\Field;
use Writecl\Rapyd\DataForm\Field\File;
use Writecl\Rapyd\DataForm\Field\Hidden;
use Writecl\Rapyd\DataForm\Field\Password;
use Writecl\Rapyd\DataForm\Field\Radiogroup;
use Writecl\Rapyd\DataForm\Field\Redactor;
use Writecl\Rapyd\DataForm\Field\Select;
use Writecl\Rapyd\DataForm\Field\Tags;
use Writecl\Rapyd\DataForm\Field\Number;
use Writecl\Rapyd\DataForm\Field\Numberrange;
use Writecl\Rapyd\DataForm\Field\Text;
use Writecl\Rapyd\DataForm\Field\Textarea;
use Writecl\Rapyd\Widget;
 ...
 *
 * @package Writecl\Rapyd\DataForm
 */
class DataForm extends Widget
{
    ...
    public function add($name, $label, $type, $validation = '')
    {
        if (strpos($type, "\\") !== false) {
            ...
            $field_class = '\Writecl\Rapyd\DataForm\Field\\' .  ucfirst($type);
        }
     ...
     * @return \Writecl\Rapyd\DataForm\Field $field
     */
    ...
    public function __call($name, $arguments)
    {
        ...
        $classname = '\Writecl\Rapyd\DataForm\Field\\'.ucfirst($name);

...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('rapyd-ajax/{hash}', array('as' => 'rapyd.remote', 'uses' => '\Writecl\Rapyd\Controllers\AjaxController@getRemote'));

    Route::namespace('Writecl\Rapyd\Demo')->prefix('rapyd-demo')->group(function() {

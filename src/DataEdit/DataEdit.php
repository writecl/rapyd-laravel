...
namespace Writecl\Rapyd\DataEdit;

use Writecl\Rapyd\DataForm\DataForm;
use Illuminate\Support\Facades\View;
use Illuminate\Support\Facades\Redirect;
use Illuminate\Support\Facades\Request;
use Illuminate\Support\Facades\Config;
use Writecl\Rapyd\Persistence;
...
class DataEdit extends DataForm
{
    ...
    protected function buildButtons()
    {
        ...
        $undoButtonClass = ['class' => 'btn btn-outline-light'];
        ...
        if ($this->status == "modify") {
            if (in_array('update',$this->back_on)) {
                $this->link($this->back_url, trans('rapyd::rapyd.undo'), $undoButtonPosition, $undoButtonClass);
            } else {
        ...
        if ($this->status == "delete") {
            ...
            $this->formButton($do_delete_url, 'delete', trans('rapyd::rapyd.delete'), $deleteButtonPosition, ["class" => "btn btn-rounded btn-fixed-w btn-danger mb-3"]);
        }
    }

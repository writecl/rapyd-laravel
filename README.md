...
<a href="https://packagist.org/packages/writecl/rapyd">
    <img src="http://img.shields.io/packagist/v/writecl/rapyd.svg?style=flat" style="vertical-align: text-top">
</a>
<a href="https://packagist.org/packages/writecl/rapyd">
    <img src="http://img.shields.io/packagist/dt/writecl/rapyd.svg?style=flat" style="vertical-align: text-top">
</a>
...
Nothing to "generate", just some classes to let you develop and maintain CRUD backends in few lines of code.  
 ...
 Documentation: [Wiki](https://github.com/writecl/rapyd-laravel/wiki)  
 
![rapyd laravel](https://raw.github.com/writecl/rapyd-laravel/master/public/assets/rapyd-laravel.png)
...
DataGrid extend [DataSet](https://github.com/writecl/rapyd-laravel/wiki/DataSet) to make data-grid output with few lines of fluent code.  
...
[DataForm explained](https://github.com/writecl/rapyd-laravel/wiki/DataForm)  
...
```php
   #article.blade.php
    ...
    {!! $form->footer !!}
```
[custom form layout explained](https://github.com/writecl/rapyd-laravel/wiki/Custom-Form-Layout)  
...
```php
  ...
  {!! $edit !!} 
```
[DataEdit explained](https://github.com/writecl/rapyd-laravel/wiki/DataEdit)  
...
[DataFilter explained](https://github.com/writecl/rapyd-laravel/wiki/DataFilter)  
...
- or import facades:
```php
    use Writecl\Rapyd\Facades\DataSet;
    use Writecl\Rapyd\Facades\DataGrid;
    use Writecl\Rapyd\Facades\DataForm;
    use Writecl\Rapyd\Facades\DataForm;
    use Writecl\Rapyd\Facades\DataEdit;
    ..
    DataGrid::source()... 
```
- or you can extend each class 
```php
    Class MyDataGrid extends Writecl\Rapyd\DataGrid\DataGrid {
    ...
    }
    Class MyDataEdit extends Writecl\Rapyd\DataEdit\DataEdit {
    ...
    }
    ..
    MyDataGrid::source()
